...
- 3D support [Buggy^2, HScript Only]
  > Note: bug at enter the song for the second time (or restart song) or has 2 models at the same time for some reason, can make the game crash if mods use 3D models. (I got headache)
